...
class UninstallCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'imperator:uninstall';
    ...
    {
        $this->laravel['files']->deleteDirectory(config('imperator.directory'));
        $this->laravel['files']->deleteDirectory(public_path('vendor/laravel-admin/'));
        $this->laravel['files']->delete(config_path('imperator.php'));
    }
}
