...
class CreateArticlesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create(config('admin.tables.article'), function (Blueprint $table) {
        ...
        Schema::create(config('admin.tables.content'), function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists(config('admin.tables.article'));
        Schema::dropIfExists(config('admin.tables.content'));
    }
}
