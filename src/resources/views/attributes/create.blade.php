          ...
          <div class="col-lg-12">
            <div class="card">
              <div class="card-body">
                ...
                @endif
                <form id="mainForm" method="post" action="{{ URL:: route('admin.category.store') }}" class="site-form">
                  {{csrf_field()}}
                  <div class="form-group">
                    <label for="username">属性名称</label>
                    <input type="text" class="form-control" name="cateName" id="cateName" placeholder="栏目名称必须唯一" value="" />
                  </div>

                  <div class="form-group">
                    <label for="typeID">属性类型</label>
                  ...
                  <div class="form-group">
                    <label for="cate_icon">属性标识</label>
                    <input class="form-control" type="text" id="attr_code" name="attr_code" placeholder="英文标识" value="">
                  </div>

                  <div class="form-group">
                    <label for="typeID">输入类型</label>
                    <div class="form-controls">
                      <select name="typeID" class="form-control" id="typeID">
                        @foreach( $types as $type)
                          <option value="{{ $type->id }}">{{ $type->var_name }}</option>
                  ...
                  <div class="form-group">
                    <label for="cate_icon">属性图标</label>
