        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="card">
              ...
              <div class="card-body">
                <form action="{{ URL::route('admin.role.update') }}" method="post">
                  {{csrf_field()}}
                  <div class="form-group">
                    <label for="example-text-input">角色名称</label>
                    <input class="form-control" type="text" name="role-input" placeholder="角色名称" value="{{ $entity-> }}">
                  </div>
                  ...
                  <table class="table table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td class="p-l-40">
                          <label class="kkadmin-checkbox checkbox-primary checkbox-inline checkbox-inline">
                      ...
                      <tr>
                        <td class="p-l-40">
                          <label class="kkadmin-checkbox checkbox-primary checkbox-inline checkbox-inline checkbox-inline">
