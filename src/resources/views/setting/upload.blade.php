              ...
              <div class="tab-pane active">
                <form action="{{ URL::route('admin.setting-update') }}" method="post" name="edit-form" class="edit-form">
                  ...
                  <div class="form-group">
                    <label for="upload_file_ext">允许文件上传后缀限制</label>
                  ...
                  <div class="form-group">
                    <label for="upload_image_size">文件上传大小限制</label>
                  ...
                  <div class="form-group">
                    <label for="upload_image_ext">允许图片上传的后缀</label>
                  ...
                  <div class="form-group">
                    <label for="upload_file_size">图片上传大小限制</label>
