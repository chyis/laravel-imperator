      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-lg-12">
            <div class="card">
              <div class="card-body">
                <form id="mainForm" method="post" action="{{ URL:: route('admin.manager.store') }}" class="site-form">
                  {{csrf_field()}}
                  <div class="form-group">
                    <label for="username">登录名</label>
                    <input type="text" class="form-control" name="username" id="username" placeholder="用户登录名必须唯一" value="" />
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="nickname" id="nickname" placeholder="输入昵称" value="" />
                  </div>
                  <div class="form-group">
                    <label for="nickname">电话</label>
                    <input type="text" class="form-control" name="phone" id="phone" placeholder="输入电话号码" value="" />
                  </div>
                  <div class="form-group">
